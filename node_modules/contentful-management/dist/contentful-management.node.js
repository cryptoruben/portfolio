...
const getBaseUrl = params => `/spaces/${params.spaceId}/environments/${params.environmentId}/workflow`;
...
function createClient(params, opts = {}) {
  ...
  `${sdkMain}/${"7.51.0"}`, params.application, params.integration, params.feature);
