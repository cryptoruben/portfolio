...
var getBaseUrl = function getBaseUrl(params) {
  return "/spaces/".concat(params.spaceId, "/environments/").concat(params.environmentId, "/workflow");
};
...
function createClient(params) {
  ...
  "".concat(sdkMain, "/").concat("7.51.0"), params.application, params.integration, params.feature);
